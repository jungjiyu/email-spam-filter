package com.email.spamfilter.ouath.example.withlogin.global.oauth2.service;

import com.email.spamfilter.ouath.example.withlogin.domain.user.SocialType;
...
import com.email.spamfilter.ouath.example.withlogin.global.oauth2.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        log.info("oauth2 로그인된 User DTO : {}",createdUser.toString() );
